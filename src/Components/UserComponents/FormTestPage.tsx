...
class CustomForm1 extends Component<IProps, IState> {
...
export const CustomForm = connect(mapStateToProps, mapDispatchToProps)(withRouter(CustomForm1))
